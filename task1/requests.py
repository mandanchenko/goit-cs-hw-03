...
try:
    ...
    cur.execute(select_tasks_for_user)
    tasks_records = cur.fetchall()
    if tasks_records:
    ...
    cur.execute(select_tasks_by_status_query)
    tasks_by_status_records = cur.fetchall()
    ...
    cur.execute(update_task_status_query, (task_id_to_update,))
    conn.commit()
    ...
    cur.execute(select_users_without_tasks_query)
    users_without_tasks_query = cur.fetchall()
    ...
    cur.execute(insert_task_query, ("New task", "Description", 1, user_id_to_add_task))
    conn.commit()
    ...
    cur.execute(select_tasks_not_done_query)
    tasks_not_done_query = cur.fetchall()
    ...
    cur.execute(delete_task_query, (task_id_to_delete,))
    conn.commit()
    ...
    cur.execute(select_users_by_email_query)
    users_by_email_query = cur.fetchall()
    ...
    cur.execute(update_user_name_query, (user_id_to_update,))
    conn.commit()
    ...
    cur.execute(select_tasks_count_query)
    tasks_count_query = cur.fetchall()
    ...
    cur.execute(select_tasks_by_domain_query)
    tasks_by_domain_query = cur.fetchall()
    ...
    cur.execute(select_tasks_without_description_query)
    tasks_without_description_query = cur.fetchall()
    ...
    cur.execute(select_tasks_in_progress_query)
    tasks_in_progress_query = cur.fetchall()
    ...
    cur.execute(select_users_and_tasks_query)
    users_and_tasks_query = cur.fetchall()
